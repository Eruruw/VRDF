...
public partial class playerprefsplus_pref: SQL4Unity.SQLRow {
public new ushort rowId { get { return Get<ushort>(8); } }
public int ID { get { return Get<int>(10); } }
public string Title { get { return Get<string>(12); } set { Set(12, value); } }
public string Type { get { return Get<string>(13); } set { Set(13, value); } }
/// <summary>
